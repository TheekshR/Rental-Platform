...
// Mock database matching the directory listings
...
export default function PropertyDetailsPage({ params }: { params: Promise<{ id: string }> }) {
  // Unwrapping Next.js dynamic routing parameter using React.use()
  ...
  useEffect(() => {
    // Find the property in our mock database
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 pt-32 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        {/* Right: Price & Quick Apply (5 Columns) */}
        <div className="lg:col-span-5">
          <div className="sticky top-24 border border-zinc-100 dark:border-zinc-800 rounded-3xl p-6 bg-white dark:bg-zinc-950 shadow-sm space-y-6">
            ...
            <div className="border-t border-zinc-50 dark:border-zinc-900 pt-6 space-y-4 text-xs font-semibold">
              ...
              <div className="flex justify-between items-center text-zinc-600 dark:text-zinc-400">
                ...
                <span>1 Month Rent (${property.price})</span>
              </div>
            </div>
